...
np.save('all_brass.npy', np_arr)
np.save('brass_train.npy', np_arr[:train_size])
np.save('brass_valid.npy', np_arr[train_size:train_size + test_size])
np.save('brass_test.npy', np_arr[train_size + test_size:])