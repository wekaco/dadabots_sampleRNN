...
np.save('all_glass.npy', np_arr)
np.save('glass_train.npy', np_arr[:train_size])
np.save('glass_valid.npy', np_arr[train_size:train_size + test_size])
np.save('glass_test.npy', np_arr[train_size + test_size:])