...
np.save('all_strings.npy', np_arr)
np.save('strings_train.npy', np_arr[:train_size])
np.save('strings_valid.npy', np_arr[train_size:train_size + test_size])
np.save('strings_test.npy', np_arr[train_size + test_size:])