...
np.save('all_tnght2.npy', np_arr)
np.save('tnght2_train.npy', np_arr[:train_size])
np.save('tnght2_valid.npy', np_arr[train_size:train_size + test_size])
np.save('tnght2_test.npy', np_arr[train_size + test_size:])