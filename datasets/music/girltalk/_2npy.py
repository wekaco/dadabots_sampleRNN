...
np.save('all_girltalk.npy', np_arr)
np.save('girltalk_train.npy', np_arr[:train_size])
np.save('girltalk_valid.npy', np_arr[train_size:train_size + test_size])
np.save('girltalk_test.npy', np_arr[train_size + test_size:])