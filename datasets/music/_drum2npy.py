...
for dp in data_paths:
    ...
    np.save(dp+'all_drums.npy', np_arr)
    np.save(dp+'drums_train.npy', np_arr[:train_size])
    np.save(dp+'drums_valid.npy', np_arr[train_size:train_size + test_size])
    np.save(dp+'drums_test.npy', np_arr[train_size + test_size:])
