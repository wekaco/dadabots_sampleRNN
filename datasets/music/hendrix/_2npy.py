...
np.save('all_hendrix.npy', np_arr)
np.save('hendrix_train.npy', np_arr[:train_size])
np.save('hendrix_valid.npy', np_arr[train_size:train_size + test_size])
np.save('hendrix_test.npy', np_arr[train_size + test_size:])