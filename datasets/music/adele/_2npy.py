...
np.save('all_adele.npy', np_arr)
np.save('adele_train.npy', np_arr[:train_size])
np.save('adele_valid.npy', np_arr[train_size:train_size + test_size])
np.save('adele_test.npy', np_arr[train_size + test_size:])